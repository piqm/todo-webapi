...
namespace Todo.WebApi.Shared.Results
{
    /// <summary>
    ...
    public static class ResultExtensions
    {
        ...
        /// </returns>
        public static Result<T> Ensure<T>(this Result<T> result, Func<T, bool> predicate, Error[] errors)
        {
            if (result.IsFailure)
            {
                return result;
            ...
            return result.IsSuccess && predicate(result.Value) ? result : Result.Failure<T>(errors);
        }
        ...
        /// </returns>
        public static async Task<T> Match<T>(this Task<Result> resultTask, Func<T> onSuccess, Func<IEnumerable<Error>, T> onFailure)
        {
        ...
        public static async Task<TOut> Match<TIn, TOut>(
            ...
            Func<IEnumerable<Error>, TOut> onFailure)
        {
